...
The **Waterman Spawn Egg** is available in the mod tab and the vanilla Spawn Eggs tab. A waterman is a persistent fisherman villager who prefers shore positions, remembers a waterside port, visibly fishes and stores the catch. When an empty River Skiff, Explorer Sloop or Merchant Schooner is nearby, he walks aboard, takes a server-driven cruise and steers back to the same port. He slows for the final approach, stops beside the actual bank or pier and only then disembarks. His autopilot plans across connected water, accounts for the width of the current hull, keeps clear of banks, solid obstacles and other watercraft, and recalculates the route instead of steering through a new obstruction. He starts avoiding other hulls early; a vessel on starboard tack (wind from the cloud drift on the right rail) has right of way. If hulls lock together he reverses and turns away until the jam breaks.

With the optional **Water World - The Atoll** mod installed, watermen frequently turn these cruises into long trading voyages. They find the nearest atoll, pick an offshore berth around its ring, visibly trade there, load the ship and their inventory with copper, iron, gold, emeralds, diamonds, netherite scrap and occasional Atoll Seeds, then return to their original port displaying an emerald block. After disembarking they carry that treasure to the chest beside their bed. Long routes are divided into safe locally checked legs and keep nearby voyage chunks active while the vessel is underway.
